...
- **Interactive vector map**: Explore the OpenFreeMap basemap with resolution-independent vector rendering, mouse navigation, and touch gestures
...
The application source is under the MIT License. See [LICENSE](LICENSE). Flatpak releases also bundle MapLibre Native Qt under its upstream licenses.
